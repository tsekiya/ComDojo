...
namespace XamlBindingInfo
{
    ...
    class XamlBindings : public winrt::implements<XamlBindings,
    ...
    public:
        ...
        void SubscribeForDataContextChanged(FrameworkElement const& object, ::XamlBindingInfo::XamlBindings& handler) override
        {
